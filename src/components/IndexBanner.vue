<template>
  <div id="banner" class="h-848px w-100% bg-cover">
    <div class="px-60 py-30 text-60px font-serif font-bold color-#fff select-none text-shadow-lg">
    <div>康乐在线</div>
...
<script setup>
import { gotoPath } from '@/utils'</script>
